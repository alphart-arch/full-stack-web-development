...
<div class="todo" class:done={todo.done}>
    <form action="/todo/{todo.uid}uid.json?_method=patch" method="post" use:enhance={{
    ...
    <form action="/todo/{todo.uid}uid.json?_method=patch" method="post" class="text" use:enhance={{
      result:processUpdatedTodoResult
    }}>
    ...
    <form action="/todo/{todo.uid}uid.json?_method=delete" method="post" use:enhance={{
